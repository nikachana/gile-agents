...
EDITOR_SYSTEM_PROMPT = (
    ...
    "- PASS2 MUST NOT degrade or revert valid improvements made by PASS1.\n"
    "- If no further change is needed, return the PASS1 text unchanged.\n"
    "- PASS2 may refine tone and enforce institutional consistency only when meaning is preserved.\n"
    "- PASS2 MUST NOT reintroduce original wording, undo PASS1 corrections, or simplify beyond PASS1.\n"
    "- Never revert to the original input if PASS1 has already improved it.\n"
