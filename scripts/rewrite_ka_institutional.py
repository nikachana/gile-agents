...
SYSTEM_PROMPT = (
    ...
    "STRICT MODE — apply minimal edits only:\n"
    "- Prefer punctuation fixes, redundancy removal, and word-order cleanup "
    "over any lexical substitution.\n"
    ...
    "Example:\n"
    "  Input:        'როგორც მთხოვეთ, მოთხოვნა გავაგზავნე ფოსტით.'\n"
    "  Good rewrite: 'როგორც მთხოვეთ, მოთხოვნა გავაგზავნე ფოსტით.'\n"
    "                or 'როგორც მთხოვეთ, მოთხოვნა ფოსტით გავაგზავნე.'\n"
    "  Bad rewrite:  changing 'მოთხოვნა' to 'დოკუმენტები', "
    "or writing 'გავგზავნე' instead of 'გავაგზავნე'."
)
